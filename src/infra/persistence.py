...
def get_checkpointer_and_store() -> Tuple[Optional[Any], Optional[Any]]:
    ...
    try:
        ...
        enable_persistence = os.getenv("ENABLE_LANGGRAPH_PERSISTENCE", "true").lower() == "true"
...
def create_langgraph_config(user_context: Dict[str, Any], thread_id: str) -> Dict[str, Any]:
    """
