...
def calculate_ndcg(
    retrieved_docs: List[str], relevance_judgments: Dict[str, int], k: int = 10
) -> float:
...
def calculate_recall(
    retrieved_docs: List[str], relevance_judgments: Dict[str, int], k: int = 50
) -> float:
...
def calculate_mean_reciprocal_rank(
    retrieved_docs: List[str], relevance_judgments: Dict[str, int]
) -> float:
...
def calculate_rank_biased_precision(
    retrieved_docs: List[str], relevance_judgments: Dict[str, int], p: float = 0.8
) -> float:
...
def calculate_expected_reciprocal_rank(
    retrieved_docs: List[str], relevance_judgments: Dict[str, int], max_grade: int = 3
) -> float:
...
def calculate_metrics_summary(
    ...
    for k in k_values:
        ...
        metrics[f"recall_at_{k}"] = calculate_recall(
            retrieved_docs, relevance_judgments, k
        )
        metrics[f"precision_at_{k}"] = calculate_precision(
            retrieved_docs, relevance_judgments, k
        )
    ...
    metrics["mean_reciprocal_rank"] = calculate_mean_reciprocal_rank(
        retrieved_docs, relevance_judgments
    )
    metrics["average_precision"] = calculate_average_precision(
        retrieved_docs, relevance_judgments
    )
    metrics["rank_biased_precision"] = calculate_rank_biased_precision(
        retrieved_docs, relevance_judgments
    )
    metrics["expected_reciprocal_rank"] = calculate_expected_reciprocal_rank(
        retrieved_docs, relevance_judgments
    )
...
def statistical_significance_test(
    metrics_a: List[float], metrics_b: List[float], alpha: float = 0.05
) -> Tuple[bool, float]:
