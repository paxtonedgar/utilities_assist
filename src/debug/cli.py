        ...
        while time.time() - start_time < args.duration:
            ...
            try:
                ...
                if args.verbose:
                    ...
                    hits = result.get('search_result', {}).get('hits', {}).get('total', {}).get('value', 0)
...
"""
    ...
    explain_parser.add_argument('--doc-id', required=True, help='Document ID to explain')
    explain_parser.add_argument('--index', default='utilities_assist', help='Index name')
    explain_parser.add_argument('--strategy', default='enhanced_rrf', 
    ...
    profile_parser.add_argument('--index', default='utilities_assist', help='Index name')
    profile_parser.add_argument('--strategy', default='enhanced_rrf',
                               choices=['enhanced_rrf', 'bm25', 'knn'],
                               help='Search strategy')
    profile_parser.add_argument('--include-explain', action='store_true',
                               help='Include explain information')
    ...
    debug_parser = subparsers.add_parser('debug-strategies', help='Compare search strategies')
    debug_parser.add_argument('query', help='Query text')
    debug_parser.add_argument('--strategies', default='enhanced_rrf,bm25',
                             help='Comma-separated list of strategies')
    debug_parser.add_argument('--index', default='utilities_assist', help='Index name')
    debug_parser.add_argument('--include-profile', action='store_true',
                             help='Include profiling information')
    debug_parser.add_argument('--include-explain', action='store_true',
                             help='Include explain information')
    ...
    analyze_parser = subparsers.add_parser('analyze-query', help='Analyze query structure')
    ...
    monitor_parser.add_argument('--index', default='utilities_assist', help='Index name')
    monitor_parser.add_argument('--strategy', default='enhanced_rrf',
                               choices=['enhanced_rrf', 'bm25', 'knn'],
                               help='Search strategy')
    ...
    slow_parser.add_argument('--threshold', type=int, default=1000,
                            help='Slow query threshold in milliseconds')
    slow_parser.add_argument('--time-window', type=int, default=24,
